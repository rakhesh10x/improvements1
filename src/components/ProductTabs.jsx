...
import { Cpu, Layers, Sparkles, AudioWaveform, Wifi, Zap, Globe, Shield, MessageSquare, Brain } from 'lucide-react';
...
const tabs = [
  {
    ...
    visual: (
      <div className="relative w-full h-full min-h-[400px] flex items-center justify-center rounded-2xl overflow-hidden bg-black border border-white/5 shadow-[inset_0_0_80px_rgba(81,45,168,0.2)]">
        {/* Glow Effects */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-purple-600/30 blur-[100px] rounded-full"></div>
        <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-blue-600/20 blur-[80px] rounded-full"></div>
        ...
        >
          ...
          <div className="w-full flex justify-between px-4 mt-6">
            ...
            <div className="w-12 h-2 rounded-full bg-purple-500/40"></div>
            <div className="w-12 h-2 rounded-full bg-white/10"></div>
          </div>
        </motion.div>
      </div>
  ...
  },
  {
    ...
    visual: (
      <div className="relative w-full h-full min-h-[400px] flex items-center justify-center rounded-2xl overflow-hidden bg-black border border-white/5 shadow-[inset_0_0_80px_rgba(59,130,246,0.15)]">
        {/* Glow Effects */}
        <div className="absolute top-1/3 left-1/4 w-72 h-72 bg-blue-600/20 blur-[120px] rounded-full"></div>
        <div className="absolute bottom-1/3 right-1/4 w-56 h-56 bg-indigo-600/20 blur-[100px] rounded-full"></div>
  ...
  },
  {
    ...
    visual: (
      <div className="relative w-full h-full min-h-[400px] flex items-center justify-center rounded-2xl overflow-hidden bg-black border border-white/5 shadow-[inset_0_0_100px_rgba(217,70,239,0.15)]">
        {/* Glow Effects */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(217,70,239,0.15)_0%,transparent_70%)]"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-fuchsia-600/30 blur-[100px] rounded-full"></div>
        ...
        >
          <div className="relative w-40 h-40 border border-fuchsia-500/30 rounded-full flex items-center justify-center bg-black/50 backdrop-blur-md">
            ...
            />
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-fuchsia-600/40 to-purple-600/40 blur-md absolute"></div>
            ...
            >
              <div className="absolute -top-2 left-1/2 w-4 h-4 bg-fuchsia-400 rounded-full shadow-[0_0_15px_rgba(232,121,249,0.8)]"></div>
              <div className="absolute bottom-4 right-2 w-3 h-3 bg-purple-400 rounded-full shadow-[0_0_10px_rgba(192,132,252,0.8)]"></div>
            </motion.div>
          </div>
        </motion.div>
      </div>
    ...
    <section className="pt-16 pb-12 bg-black relative z-10 overflow-hidden border-t border-white/5">
      <div className="max-w-[1360px] mx-auto px-6">
        ...
        <div className="flex justify-center mb-10">
          <div className="flex items-center gap-2 md:gap-4 p-1.5 rounded-full bg-white/[0.03] border border-white/5 backdrop-blur-md">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`relative px-6 md:px-8 py-3 rounded-full text-sm md:text-base font-medium transition-all duration-300 ${
                  activeTab === tab.id 
                    ? 'text-white' 
