...
// Export CenterExpandingGrid as a wrapper around the CanvasRevealEffect to keep BlogPage untouched
const CenterExpandingGrid = () => {
  return (
    <div className="absolute inset-0 z-0">
      <CanvasRevealEffect
        ...
        reverse={false}
      />
      {/* Dark vignette to focus the center, exactly as the user's reference code has */}
...
export default CenterExpandingGrid;
