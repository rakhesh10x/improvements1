...
const CustomCursor = () => {
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-10 h-10 border border-white/50 bg-white/5 backdrop-blur-[2px] rounded-full pointer-events-none z-[9998] hidden md:block mix-blend-difference"
        animate={{
