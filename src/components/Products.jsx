      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 auto-rows-[minmax(300px,auto)]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            whileHover={{ y: -6 }}
            className="md:col-span-8 glass-card p-10 rounded-2xl flex flex-col md:flex-row gap-8 items-start md:items-center relative overflow-hidden group"
          >
            ...
            <div className="flex-1 relative z-10">
              <div className="bg-purple-500/10 border border-purple-500/20 p-4 rounded-xl mb-8 group-hover:scale-110 transition-transform duration-500 w-fit">
                {products[0].icon}
              </div>
          ...
          <motion.div
            ...
            transition={{ delay: 0.1 }}
            whileHover={{ y: -6 }}
            className="md:col-span-4 glass-card p-10 rounded-2xl flex flex-col relative overflow-hidden group"
          >
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 p-4 rounded-xl mb-8 group-hover:scale-110 transition-transform duration-500 relative z-10 w-fit">
              {products[1].icon}
            </div>
            <h4 className="text-2xl font-bold text-text-primary mb-4 relative z-10 tracking-tight">
              {products[1].title}
          ...
          <motion.div
            ...
            transition={{ delay: 0.2 }}
            whileHover={{ y: -6 }}
            className="md:col-span-12 glass-card p-10 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-10 relative overflow-hidden group"
          >
            ...
            <div className="flex items-start md:items-center gap-8 relative z-10 max-w-2xl flex-col md:flex-row">
